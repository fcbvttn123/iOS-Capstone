...
class EventDispalyScreen: UIViewController {
    ...
    // Action method for the register button.
    ...
    - Parameters:
       - selectedCampus: The selected campus for the event.
       - selectedRow: The selected row for the event.
       - completion: Completion block returning a boolean indicating whether the user is already registered.
    */
    ...
    /**
     Gets the event data for the selected event.
